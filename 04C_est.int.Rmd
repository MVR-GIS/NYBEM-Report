...
A relative change in velocity from a baseline condition is used as a proxy for more complex edge erosion processes. This assumes that all things being equal, if currents and velocities increase significantly then erosion is likely to increase as well. We assume that any increase in high velocity conditions beyond 10% is detrimental, and that increases beyond 30% would fundamentally alter the character of a given marsh. High velocity conditions are identied as the 90th percentile velocity over a period of record, which would generally correlate with storm conditions when erosion would be likely.
