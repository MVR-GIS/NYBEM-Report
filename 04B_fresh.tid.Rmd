...
$$salinity.high.dur = \begin{pmatrix} -0.02*sal_{dur}+1 & sal_{dur}=0-50\\
0.0 & sal_{dur}=50-100
\end{pmatrix}$$

Where $salinity.high.dur$ is a suitability index relative to high salinity periods and $sal_{dur}$ is the percent of time salinity is greater than the threshold for freshwater tidal habitat (i.e., salinity > 5 psu).
