...
```{r, fig.cap="Example of suitability calculations for the estuarine intertidal model. The left panel show the percent of land use in urban uses, and the right panel shows the normalized (0 to 1) suitability outcome."}
