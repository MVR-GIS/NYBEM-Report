...
author: S. Kyle McKay, Vanessa Mahan, Michael P. Dougherty, Toddd M. Swannack, Candice
...
documentclass: book
bibliography:
- Draftbooksubmodel.bib
- packages.bib
biblio-style: apalike
link-citations: no
description: The U.S. Army Corps of Engineers (USACE) is conducting three large-scale
  coastal storm risk management feasibility studies in the New York Bight ecosystem,
  This report documents the development of this tool, including information on model
  scoping, the development process, conceptualization, quantification, and evaluation.
