...
The est.int and est.sub models also strongly differentiate habitat suitability predictions among sites with and without wetlands. This finding indicates that the models generally distinguish between features strongly, and the HSI formulation may provide value for distinguishing ecosystem condition. The fresh.tid model does not provide clear differentiation of HSI values, and additional analyses are underway to better understand these effects.
