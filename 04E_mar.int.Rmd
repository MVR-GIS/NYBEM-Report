...
- Other habitat suitability models: Plover [@farmer_habitat_2000, @seavey_effect_2011], Horseshoe Crab [@avissar_modeling_2006, @nancy_jackson_armoring_2010, @lathrope_mapping_2013], and amaranth [@sellars_habitat_2007]  
...
$I_{mar.int} = \frac{beach.slope + exp.dur + land.use + shoreline}{5}$ 
...
NYBEM.mar.int <- data.frame(matrix(NA,nrow=3,ncol=8))
